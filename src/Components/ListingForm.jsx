        ...
        <Transition.Root show={sidebarOpen} as={Fragment}>
          ...
          >
            ...
            <div className="fixed inset-0 z-40 flex">
              ...
              >
                <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-red-600 pt-5 pb-4">
                  <Transition.Child
                    as={Fragment}
                      ...
                      {navigation.map((item) => (
                        <a
                          ...
                          className={classNames(
                            item.current
                              ? "bg-akira-blue text-white"
                              : "text-white hover:bg-akira-blue",
                ...
                {navigation.map((item) => (
                  <a
                    ...
                    className={classNames(
                      item.current
                        ? " bg-akira-blue text-white"
                        : "text-indigo-100 hover:bg-akira-blue",
